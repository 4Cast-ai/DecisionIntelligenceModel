...
namespace Infrastructure.Controllers
{
    ...
    public class GeneralControllerBase : ControllerBase
    {
        ...
        //private readonly Lazy<GeneralHttpClient> _FillerClient = new Lazy<GeneralHttpClient>(() => GeneralContext.CreateRestClient(ApiServiceNames.FillerApi));
        ///// <summary> Current Filler http rest client for access to FillerApi </summary>
        //public GeneralHttpClient FillerApi => _FillerClient.Value;
