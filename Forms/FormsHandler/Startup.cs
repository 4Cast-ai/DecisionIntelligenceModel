...
namespace FormsHandler
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v2", new OpenApiInfo { Title = "FormsHandler Service WebAPI", Version = "v 2.0.0" });
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.IndexStream = () => GetType().Assembly.GetManifestResourceStream("FormsHandler.api.index.html");
                c.RoutePrefix = "api";
                c.SwaggerEndpoint("/swagger/v2/swagger.json", $"{Assembly.GetEntryAssembly().GetName().Name}");
                c.DocumentTitle = "FormsHandler WebAPI";
                c.OAuthUsePkce();
