...
namespace FormsHandler.Controllers
{
    ...
    [ApiController]
    public class EventController : GeneralControllerBase
    {
        ...
        public async Task<bool> CreateEvent(EventDataObject eventData)
        {
        ...
        public async Task<IActionResult> UpdateEvent(EventDataObject eventData)
        {
