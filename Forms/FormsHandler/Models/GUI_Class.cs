...
namespace FormsHandler.Models
{
    ...
    public class ModelData
    {
        ...
        string _model_name;
        string _model_description;
        List<string> _Models_for_unit_types = new List<string>();
        List<string> _Models_Permissions = new List<string>();

        string _model_guid;
        double _model_id;
        string _model_modified_date;

        string _model_status;

        string _model_create_date;
        string _model_creator_user_guid;
        string _model_edit_user_guid;
        bool _is_master_model;

        public int user_admin_permission { get; set; }
        public string model_parent_guid { get; set; }
        public string model_guid { get { return _model_guid; } set { _model_guid = value; } }
        public double model_id { get { return _model_id; } set { _model_id = value; } }
        public string model_modified_date { get { return _model_modified_date; } set { _model_modified_date = value; } }
        public string model_status { get { return _model_status; } set { _model_status = value; } }
        public string model_create_date { get { return _model_create_date; } set { _model_create_date = value; } }
        public string model_creator_user_guid { get { return _model_creator_user_guid; } set { _model_creator_user_guid = value; } }
        public string model_edit_user_guid { get { return _model_edit_user_guid; } set { _model_edit_user_guid = value; } }

        public string model_name { get { return _model_name; } set { _model_name = value; } }
        public string model_description { get { return _model_description; } set { _model_description = value; } }
        public List<string> Models_for_unit_types { get { return _Models_for_unit_types; } set { _Models_for_unit_types = value; } }
        public List<string> Models_Permissions { get { return _Models_Permissions; } set { _Models_Permissions = value; } }
        public bool is_master_model { get { return _is_master_model; } set { _is_master_model = value; } }
    }
