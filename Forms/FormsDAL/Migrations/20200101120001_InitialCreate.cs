...
namespace Model.Migrations
{
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Types().Configure
...
//                guid    character varying(50) 
            ...
            migrationBuilder.CreateTable(
               ...
               columns: table => new
               {
                   ...
                   UnitTypeName = table.Column<string>(maxLength: 50, nullable: false)
               },
               constraints: table =>
               {
                   table.PrimaryKey("UnitType_pkey", x => x.UnitTypeId);
               });
            ...
            //        UnitTypeGuid = table.Column<string>(maxLength: 50, nullable: true),
         ...
         columns: table => new
         {
          ...
          constraints: table =>
          {
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Organization_Object_Connection_Model_Component",
                table: "OrganizationObjectConnection",
                column: "ModelComponentGuid",
                principalTable: "ModelComponent",
                principalColumn: "ModelComponentGuid",
