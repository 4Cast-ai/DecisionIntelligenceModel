...
namespace FormsDal.Controllers
{
    ...
    [ApiController]
    public class EventController : ControllerBaseAction
    {
        private readonly EventService _eventService;
        
        public EventController(EventService _event)
        {
        ...
        public async Task<IActionResult> UpdateEvent([FromBody] EventDataObject eventData)
        {
