...
namespace Events
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v2", new OpenApiInfo { Title = "Events Service WebAPI", Version = "v 2.0.0" });
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.IndexStream = () => GetType().Assembly.GetManifestResourceStream("Events.api.index.html");
                c.RoutePrefix = "api";
