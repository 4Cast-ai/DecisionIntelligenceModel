...
namespace Infrastructure.Core
{
    ...
    public static class GeneralExtentions
    {
        ...
        public static void ConfigureUnitOfWork<T>(this IServiceCollection services) where T : Context
        {
        ...
        //public static IEnumerable<T> GetFlattenList<T>(this IEnumerable<T> source) where T: OrganizationObjectData
        //{
        //    return source.Concat(source.SelectMany(i => GetFlattenList<T>(i.children as IEnumerable<T>)));
        //}
    }
}
