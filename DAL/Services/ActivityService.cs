...
namespace Dal.Services
{
    public class ActivityService : BaseService
    {
        ...
        //                            where a.EstimateUnits.Contains(orgObjGuid) || a.EstimatePersons.Contains(orgObjGuid) 
        //    //orderby a.Name
        //    select new MultiActivityData(a, at)).ToListAsync();

        //    return activities;
        //}
        //public async Task<List<ActivityDetails>> GetMultiActivityItems(string activity_group_guid)TODO activityconections
        //{
        ...
        //        existing.EstimatePersons = data.EstimatePersons;
        //        existing.EstimateUnits = data.EstimateUnits;    
        //        //existing.OrgObjGuidList = data.OrgObjGuidList;
        //        existing.Units = data.Units;
        //        existing.Persons = data.Persons;    
        ...
        public async Task<string> CreateActivity(ActivityDetails activity_data, List<Participant> participants)
        {
            ...
            Activity activity = new Activity
            {
                ...
                //EntityGuid = _guid,
                //EntityGuidType = guid_Type,
                Name = activity_data.name,
                Description = activity_data.description,
                Users = activity_data.users,
                AnonymousEvaluation = activity_data.anonymousEvaluation,
                ActivityTemplateGuid = activity_data.activity_template.activity_template_guid
            };
            ...
            foreach (var participant in participants)
            {
                ...
                foreach (var evaluator in participant.EvaluatorList)
                {
                    ...
                    {
                        ActivityEntity = activityEntity.ActivityEntityId,
                        EstimatedGuid = evaluator.EvaluatorGuid,
                        EstimatedType = evaluator.EvaluatorType
                    };

                    DbContext.ActivityEstimator.Add(activityEstimator);
                    DbContext.SaveChanges();
                }
            }
        ...
        public async Task<string> UpdateActivity(ActivityDetails activity_data, List<Participant> participants)
        {
            ...
            //activity.EntityGuid = _guid;  
            //activity.EntityGuidType = guid_type;   
        ...
        //public async Task<bool> DeleteItemFromMultiActivity(string orgObjGuid, string activityGroupGuid)TODO activityconections
        //{
        //    //var existActivity = DbContext.Activity.FirstOrDefault(a => a.OrgObjGuid == orgObjGuid && a.ActivityGroupGuid == activityGroupGuid);
        //    var existActivity = DbContext.Activity.FirstOrDefault(a => a.EntityGuid == orgObjGuid && a.ActivityGroupGuid == activityGroupGuid);
        ...
        //public async Task<bool> DeleteMultiActivity(string org_obj_guid, string activity_group_guid)TODO activityconections
        //{
        //    bool result = true;

        //    //var activity = DbContext.Activity.FirstOrDefault(a => a.ActivityGroupGuid == activity_group_guid && a.OrgObjGuid == org_obj_guid);TODO
        //    var activity = DbContext.Activity.FirstOrDefault(a => a.ActivityGroupGuid == activity_group_guid && a.EntityGuid == org_obj_guid);
