    ...
    public Context(DbContextOptions<Context> options)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActivityTemplate>(entity =>
            {
                ...
                entity.Property(e => e.WithinTimeRange);
             
                entity.Property(e => e.SubmitOnlyOnce);
            ...
            {
                entity.HasKey(e => new { e.ActivityTemplateGuid, e.DescriptionGuid })
                ...
                entity.Property(e => e.DescriptionGuid).HasMaxLength(50);
            ...
            {
                entity.HasKey(e => new { e.EntityGuid, e.DescriptionGuid })
