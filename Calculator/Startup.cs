...
namespace Calculator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v2", new OpenApiInfo { Title = "4cast Calculator Service WebAPI", Version = "v 2.0.0" });
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.IndexStream = () => GetType().Assembly.GetManifestResourceStream("Calculator.api.index.html");
                c.RoutePrefix = "api";
                c.SwaggerEndpoint("/swagger/v2/swagger.json", $"{Assembly.GetEntryAssembly().GetName().Name}");
                c.DocumentTitle = "4cast Calculator WebAPI";
                c.OAuthUsePkce();
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGet("/", context =>
                {
                    ...
                    //await context.Response.WriteAsync($"{Assembly.GetEntryAssembly().GetName().Name} API run!!!");
